                    ...
                    <tbody class="divide-y divide-gray-100">
                        ...
                        <tr class="hover:bg-gray-50/50 transition">
                            <td class="px-6 py-4">
                                ...
                                <div class="mt-2">
                                    <span class="inline-flex items-center px-2 py-0.5 rounded text-[10px] font-bold bg-orange-100 text-orange-800 border border-orange-200 shadow-sm" title="Skor Relevansi TF-IDF">
                                        <svg class="w-3 h-3 mr-1 text-orange-600" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 10V3L4 14h7v7l9-11h-7z"></path></svg>
                            ...
                            <td class="px-6 py-4 text-center whitespace-nowrap space-x-2">
                                <button onclick="openModal('{{ asset('storage/' . $arsip->file_path) }}')" type="button" class="inline-flex items-center px-4 py-2 bg-emerald-50 text-emerald-700 hover:bg-[#085a3a] hover:text-white text-xs font-bold rounded-lg transition border border-emerald-200">
                                    BUKA
                                </button>
                                ...
                                {{-- =============================================== --}}
                                <a href="{{ route('arsip.show', $arsip->id) }}" class="inline-flex items-center px-4 py-2 bg-blue-50 text-blue-700 hover:bg-blue-600 hover:text-white text-xs font-bold rounded-lg transition border border-blue-200">
                                ...
                                @if($canEdit)
                                    <a href="{{ route('arsip.edit', $arsip->id) }}" class="inline-flex items-center px-4 py-2 bg-amber-50 text-amber-700 hover:bg-amber-500 hover:text-white text-xs font-bold rounded-lg transition border border-amber-200">
                                        EDIT
                                    </a>
                                    ...
                                    <form action="{{ route('arsip.destroy', $arsip->id) }}" method="POST" class="inline">
                                        @csrf
                                        @method('DELETE')
                                        <button type="submit" onclick="return confirm('Yakin ingin menghapus dokumen ini?')" class="inline-flex items-center px-4 py-2 bg-red-50 text-red-700 hover:bg-red-600 hover:text-white text-xs font-bold rounded-lg transition border border-red-200">
                                            HAPUS
                                        </button>
                                    </form>
                                @endif
                        ...
                        <tr>
                            <td colspan="4" class="px-6 py-20 text-center text-gray-400">
                                <div class="flex flex-col items-center">
                                    <svg class="w-16 h-16 mb-4 text-gray-300" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path d="M20 13V6a2 2 0 00-2-2H6a2 2 0 00-2 2v7m16 0v5a2 2 0 01-2 2H6a2 2 0 01-2-2v-5m16 0h-2.586a1 1 0 00-.707.293l-2.414 2.414a1 1 0 01-.707.293h-3.172a1 1 0 01-.707-.293l-2.414-2.414A1 1 0 006.586 13H4"></path></svg>
